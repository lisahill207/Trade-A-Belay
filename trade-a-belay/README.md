...
This React project was built based on feedback from my local climbing community.
...
To address this need, I used React to build a virtual Trade-A-Belay board which allows users to create a profile and find other climbers with compatible styles. The board is on a copy of our local gym's website.
