...
const Signup = () => {
  return (
    <>
      <div className="grow max-w-md mx-auto login-form text-white flex flex-col justify-center content-center p-4">
        ...
        <div className="flex flex-row justify-center items-center">
          ...
          <div>
            <select className="select text-base m-4 self-center select-bordered flex items-center gap-2">
            ...
            <textarea
              className="textarea textarea-bordered text-base mx-4 self-center "
              placeholder="Bio"
            ></textarea>
          </div>
        </div>
