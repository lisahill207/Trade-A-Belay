  ...
  return (
    <>
      <div className=" login-form text-white flex flex-col justify-center content-center w-dvw p-4">
        <h2 className="self-center py-2 text-2xl">
          Sign Up to find your next climbing partner
        </h2>
        <p className="self-center py-2 ">
          Already a member?<a href={`/login`}> Login here.</a>
        </p>
        <label className="w-60 m-4 self-center input input-bordered flex items-center gap-2">
          <svg
        ...
        <label className="w-60 m-4 self-center input input-bordered flex items-center gap-2">
          ...
          <input type="password" className="" value="Password" />
        </label>
        <select className="select w-60 m-4 self-center select-bordered flex items-center gap-2">
        ...
        <textarea
          className="textarea textarea-bordered w-60 m-4 self-center "
          placeholder="Bio"
        ></textarea>
      </div>
    </>
