...
const Footer2 = () => {
  return (
    <div className="m-3 w-95dvw md:w-dvw">
      <div className="flex justify-start text-white md:flex-col md:justify-center md:items-center md:text-center">
        <ul className="border-r-2 md:border-none px-3" id="footer-box1-list">
          <li className="list-none">WHY US</li>
          <li className="list-none">FIRST VISIT</li>
          <li className="list-none">MEDIA CENTER</li>
        </ul>
        <ul className="border-r-2 md:border-none px-3" id="footer-box2-list">
        ...
        <ul className="border-r-2 md:border-none px-3" id="footer-box3-list">
